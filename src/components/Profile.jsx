...
export default function Profile() {
  ...
  function handleSubmit(e) {
    ...
    if (photo !== "") {
      promises.push(updateProfilePhotoUrl(photo));
    }
  ...
  return (
    <div className="font-mono static h-dvh">
      ...
      <div className="container mx-auto flex justify-center h-full">
        <div className="card w-2/5 bg-base-100 border border-primary shadow-xl mt-32 mb-20">
            ...
            <div className="card w-full h-full">
              <div className="card-body">
                <div className="avatar">
                  <div className="w-24 rounded-full outline outline-secondary">
                    <img src={photoURL} />
                  </div>
                </div>
                <div className="space-y-4">
                  <h2 className="text-xl font-bold mb-10">Account's Info</h2>
                  <div className="">
